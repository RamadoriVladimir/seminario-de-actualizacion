class ApplicationModel {
    ...
    saveInventory() {
        sessionStorage.setItem('inventoryData', JSON.stringify(Array.from(this._inventoryData.entries())));
    }

    saveAuthData() {
        sessionStorage.setItem('authData', JSON.stringify(Array.from(this._authData.entries())));
    }
